...
public class ConfigLocationHelper
{
	...
	public static String getClassPath(String name)
	{
		try
		{
			return URLDecoder.decode(ConfigLocationHelper.class.getClassLoader().getResource(name).getPath(), Charset.defaultCharset().toString());
		}
	...
	private static void getConfigLocations(File rootDir, String currentPath, String cfgFileName, String prefix, Set<String> files)
	{
